...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENC5_A_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC5_B_Pin);
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(ENC6_A_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC6_B_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC7_A_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC8_A_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC8_B_Pin);
  HAL_GPIO_EXTI_IRQHandler(ENC7_B_Pin);
